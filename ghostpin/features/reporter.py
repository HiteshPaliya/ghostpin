"""
GhostPin Enterprise v5.0 — Feature: Smart Report Generator
...
def generate_report(report_data: dict, output_path: Path) -> str:
    ...
    tester = report_data.get('tester', 'GhostPin Enterprise')
...
<div class="cover">
  ...
  <div class="cover-meta">
    ...
    <div class="cover-meta-item">Tool<strong>GhostPin Enterprise v5.0</strong></div>
  </div>
</div>
...
<div class="footer">
  Generated by GhostPin Enterprise v5.0 · {now.strftime("%Y-%m-%d %H:%M:%S")} ·
